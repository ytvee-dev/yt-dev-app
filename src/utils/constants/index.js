export const links = {
    ...
    INSTA: "https://www.instagram.com/youjin.tyan/",
};
...
export const mediaCards = [
    {
        ...
        title: "Jasa Kids",
        description:
            "Выступление с темой “IT в нашей жизни” для детей из детских домов Казахстана.",
        link: "https://t.me/YTvDev/596",
        imagePath:
            "https://res.cloudinary.com/duyqvi0ig/image/upload/v1723146146/1_b10jqw.png",
    },
    {
        id: "podcast",
        title: "Podcast",
        ...
        imagePath:
            "https://res.cloudinary.com/duyqvi0ig/image/upload/v1723146146/2_q0bfle.png",
    },
    {
        id: "kids",
    ...
    {
        id: "habr",
        title: "Личный блог на хабре",
        description:
            "Пишу про инструменты и методы в IT-образовании, Frontend-разработку и научпоп.",
        link: "https://habr.com/ru/users/youjintyan/publications/articles/",
        imagePath:
            "https://res.cloudinary.com/duyqvi0ig/image/upload/v1731318977/habr-about_nm2dwo.png",
    },
];
...
export const workingExperience = [
    {
        company: "Singularity Net",
        years: "[с окт 2023]",
        role: "Frontend",
        description: "Разработка интерфейсов для blockchain-сервисов",
        stack: "React.js, Vue.js, Web3",
    },
    {
        company: "Choco Family",
        years: "[авг 2022 - янв 2023]",
        role: "Frontend",
        description: "Работа с интерфейсами магазина ChocoFood",
        stack: "Vue.js, Vite, Vuetify",
    },
    {
        company: "xCritical Software",
        years: "[фев 2019 - янв 2020]",
        role: "Backend",
        description: "Разработка CRM-систем",
        stack: "ASP.NET C#",
    },
    {
        company: "Freelance",
        years: "[авг 2018 - мар 2019]",
        role: "Backend",
        description: "Разработка чат-ботов для Telegram",
        stack: "Python, PostgreSQL, Docker",
    },
    {
        company: "Lab of the Future",
        years: "[сен 2014 - авг 2015]",
        role: "Backend",
        description: "Поддержка платформы документооборота",
        stack: "IBM Domino, Lotus Script",
    },
];
...
export const skillsDescription = [
    ...
    "Python | Telegram API",
    "Bootstrap, Material-UI | MS SQL Server, PostgreSQL",
];
...
export const serviceMeta = [
    ...
    {
        id: "fullDev",
        title: "Разработка веб-сервиса под ключ",
        subTitle: "Дизайн | Backend | Frontend",
        description:
    ...
    },
    {
        ...
        subTitle: "Telegram | Боты | mini-App",
        description:
    ...
    {
        id: "audit",
        title: "Аудит веб-сервисов и Telegram-ботов",
        subTitle: "Боты | Сайты | Веб-сервисы",
        description:
            "Мы тщательно изучаем архитектуру, кодовую базу, производительность, безопасность и пользовательский опыт. В ходе аудита выявляем уязвимости, неэффективности и потенциальные точки роста, а также даем рекомендации по оптимизации. В итоге вы получаете подробный отчет с практическими советами, который поможет сделать ваше приложение более надежным, быстрым и удобным для пользователей.",
        imagePath:
            "https://res.cloudinary.com/duyqvi0ig/image/upload/v1727808606/audit_xdu1gk.svg",
        imageMobilePath:
            "https://res.cloudinary.com/duyqvi0ig/image/upload/v1727808606/audit_xdu1gk.svg",
    },
];
